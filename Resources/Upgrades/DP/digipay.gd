...
var emilija_icon: CompressedTexture2D = preload("res://Sprites/mom.png")
...
func upgrade_dp(game_main: GameMain, dp: DistributionPoint) -> void:
	...
	if (!sent_msg):
		var arr: Array[CustomText] = [
			CustomText.create("Emilija: As much as I like cash, this has truly made things easier—and quicker too! ", 10, emilija_icon)
		]
